...
\begin{frame}{EXO-20-002: Flavor Control Region}
  \begin{columns}
    \begin{column}{0.50\textwidth}
      \centering
      \includegraphics[width=\textwidth]{../figures/histograms/exo-20-002/PostFit_WRCand_Mass_HNWR_EMu_Resolved_SR.pdf}
    \end{column}
    \begin{column}{0.50\textwidth}
        \vspace*{-15mm}
        \centering
...
\begin{frame}{EXO-20-002: Control Region}
  \begin{block}{Mixed Agreement}
    Hadronic variables are mismodelled in the DY CR, due to order (LO) of the DY sample.
  \end{block}
  \vfill
  \begin{columns}
    \begin{column}{0.45\textwidth}
      ...
      \includegraphics[width=0.90\textwidth]{%
        ../figures/histograms/exo-20-002/Lepton_0_Pt_HNWR_SingleElectron_Resolved_DYCR.pdf}
    \end{column}
    \begin{column}{0.45\textwidth}
      \centering
      \includegraphics[width=0.90\textwidth]{%
        ../figures/histograms/exo-20-002/AfterZPtReweight_ToBeCorrected_Jet_Pt_HNWR_SingleElectron_Resolved_DYCR.pdf}
    \end{column}
  \end{columns}
\end{frame}
  ...
  \begin{columns}
    \begin{column}{0.45\textwidth}
      \includegraphics[width=\textwidth]{%
        ../figures/histograms/exo-20-002/BeforeZPtReweight_ZCand_Pt_HNWR_SingleElectron_Resolved_DYCR.pdf}
    \end{column}
    \begin{column}{0.5\textwidth}
      \begin{block}{}
        \begin{itemize}
...
\begin{frame}{EXO-20-002: $p_T^{\ell \ell}$ Correction}
  ...
  \begin{columns}
    ...
    \begin{column}{0.45\textwidth}
      \includegraphics[width=0.9\textwidth]{%
        ../figures/histograms/exo-20-002/AfterZPtReweight_ZCand_Pt_HNWR_SingleElectron_Resolved_DYCR.pdf}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{EXO-20-002: Jet $p_T$ Reweighting}
  \begin{columns}
    \begin{column}{0.45\textwidth}
      \includegraphics[width=\textwidth]{%
        ../figures/histograms/exo-20-002/DYReshapeRatio_2018_Resolved.pdf}
    \end{column}
    \begin{column}{0.5\textwidth}
      \begin{block}{}
        \begin{itemize}
...
\begin{frame}{EXO-20-002: Control Region $m_{\ell\ell j j}$}
  \begin{block}{}
    The $m_{\ell\ell j j}$ in the low $m_{\ell\ell}$ DY CR, before (left) and after (right) applying the DY ratio.
  \end{block}
  \vfill
  \begin{columns}
    \begin{column}{0.45\textwidth}
      \includegraphics[width=0.8\textwidth]{%
        ../figures/histograms/exo-20-002/AfterZPtReweight_WRCand_Mass_HNWR_SingleMuon_Resolved_DYCR.pdf}
    \end{column}
    \begin{column}{0.45\textwidth}
      \includegraphics[width=0.8\textwidth]{%
        ../figures/histograms/exo-20-002/AfterZPtReweight_AfterDYReshape_WRCand_Mass_HNWR_SingleMuon_Resolved_DYCR.pdf}
    \end{column}
  \end{columns}
  \begin{block}{}
    \centering
    \boldcol{UMNSunny}{The correction improves the $m_{\ell\ell j j}$ distribution in the DY CR.}
  \end{block}
\end{frame}
...
\begin{frame}{Looking forward to Run 3}
  \begin{block}{Run 3 Focus}
    Improving the DY background estimation from EXO-20-002 is a focus at the moment.
  \end{block}

  \begin{columns}
    \begin{column}{0.45\textwidth}
      \includegraphics[width=0.90\textwidth]{%
        ../figures/histograms/lo_vs_nlo_mass_fourobject_mumu_resolves_sr.pdf}
    \end{column}
    \begin{column}{0.45\textwidth}
      \begin{block}{Several Paths}
        \begin{itemize}
          \item Use NLO DY sample and avoid reweighting.
          \item Stay with LO DY sample and choose a different reweighting variable.
          \item Fit the background instead of relying on simulation.
        \end{itemize}
      \end{block}
    \end{column}
  \end{columns}
...
\begin{frame}{LO $m_{jj}$ reweighting}
  \begin{block}{}
    Use same jet-$p_T$ reweighting procedure, but derive reweights from the $m_{jj}$ distribution.
  \end{block}
  \begin{columns}
    \begin{column}{0.45\textwidth}
      \centering
      \includegraphics[width=0.80\textwidth]{%
        ../figures/histograms/before_mjj_reshape.pdf}
    \end{column}
    \begin{column}{0.45\textwidth}
      \centering
      \includegraphics[width=0.80\textwidth]{%
        ../figures/histograms/after_mjj_reshape.pdf}
    \end{column}
  \end{columns}
  \begin{block}{}
    \centering
    \boldcol{UMNSunny}{The DY CR shows better agreement using $m_{jj}$ reweights compared to jet-$p_T$.}
  \end{block}
\end{frame}
...
\begin{frame}{SR DY Reweighted by $m_{jj}$}
  \begin{block}{}
    $m_{jj}$ reweights do not have a large impact on the $m_{\ell \ell j j}$ distribution in the signal region.
  \end{block}
  \begin{columns}
    \begin{column}{0.45\textwidth}
      \centering
      \includegraphics[width=0.90\textwidth]{%
        ../figures/histograms/mass_fourobject_premjj_mumu_resolved_sr.pdf}
    \end{column}
    \begin{column}{0.45\textwidth}
      \centering
      \includegraphics[width=0.90\textwidth]{%
         ../figures/histograms/mass_fourobject_mjj_mumu_resolved_sr.pdf}
    \end{column}
  \end{columns}
\end{frame}
